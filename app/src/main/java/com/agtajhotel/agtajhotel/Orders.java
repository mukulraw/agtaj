...
import com.agtajhotel.agtajhotel.ordersPOJO.Model;
...
public class Orders extends AppCompatActivity {
    ...
    public void loadData()
    {
        ...
        CookieManager cookieManager = new CookieManager(new PersistentCookieStore(Orders.this), CookiePolicy.ACCEPT_ALL);
        ...
        Call<ordersBean> call = cr.getOrders();
